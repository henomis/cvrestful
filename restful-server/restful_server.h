...
static const char *json_personal = "{ \
    \"personal\": [ \
        { \
            \"title\": \"Hosted at GitHub (<a target='_blank' href='https://github.com/henomis'>repository</a>)\", \
            \"projects\": [ \
                \"<a target='_blank' href='https://github.com/henomis/cvrestful'>CVrestful</a> - This content! Yes the one that you are seeing!\", \
                \"<a target='_blank' href='https://github.com/henomis/jquery-quiz'>jQuery-quiz</a> -  jQuery plugin that permits to build quiz pages.\" \
            ] \
        }, \
        { \
            \"title\": \"Hosted at SourceForce (<a target='_blank' href='http://sourceforge.net/users/simone_vellei'>repository</a>)\", \
            \"projects\": [ \
                \"<a target='_blank' href='http://www.flatnuke.org'>FlatNuke</a> - Content Management System based on flat-file database\", \
                \"<a target='_blank' href='http://stork.sf.net'>Stork</a> -  SystemV Transport tO Remote Kernel, Distributed SystemV layer extension for Linux kernel, 2.6 (Master degree thesis).\", \
                \"<a target='_blank' href='http://sourceforge.net/projects/freepops/'>FreePOPs</a> - Extensible POP3 server (Italian OpenSourceContest 2004 winner).\", \
               \"<a target='_blank' href='http://eucaristos.sf.net'>EucaristOS</a> A small GNU/Linux distribution with openMosix clusters support\" \
            ] \
        }, \
        { \
            \"title\": \"Hosted at GitLab (<a target='_blank' href='https://gitlab.com/henomis'>repository</a>)\", \
            \"projects\": [ \
                \"<a target='_blank' href='https://gitlab.com/virtualdamien/virtualdamien/tree/master'>VirtualDamien</a>. Dynamic generator of Damien Hirst spot painting art.\", \
                \"<a target='_blank' href='https://gitlab.com/virtualjerry/virtualjerry/tree/master'>VirtualJerry</a>. Dynamic generator of Jerry Bergonzi jazz method exercises\", \
                \"<a target='_blank' href='https://gitlab.com/emoneyc/btcec/tree/master'>BtceC</a> and <a target='_blank' href='https://gitlab.com/emoneyc/vircurexc/tree/master'>VircurexC</a>. Btc-e.com and Vircurex.com digital currency trading API clients in C.\" \
            ] \
        },{ \
           \"title\": \"Conferences\", \
            \"projects\": [ \
               \"Conferences speaker in italian language (<a target='_blank' href='https://henomis.wordpress.com/conferenze/'>complete list</a>).\" \
            ] \
        } \
]}";
